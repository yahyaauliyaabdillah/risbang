...
<div class="wrapper">
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3 fs-6">Data Dosen</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item fs-6"><a href="{{route('home')}}"><i class="bi bi-house-fill"></i> Beranda /</a> Dosen
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body ">
                <div class="d-flex align-items-center">
                    <div class="">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleLargeModal"><i class="bi bi-calendar2-plus-fill"></i> Tambah Dosen</button>
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>0712398454</td>
                                <td>0712398454</td>
                                <td>https://risbang.unuja.ac.id/media/arsip/ktp/KTP_Fuad_Hasan_2023.jpg </td>
                                <td>ttps://risbang.unuja.ac.id/media/arsip/npwp/NPWP_Fuad_Hasan.jpg</td>
                                <td>1</td>
                            ...
                            <tr>
                                ...
                                <td>FATHOR ROZI, M.Pd.-0709118806 (Pendidikan Agama Islam)</td>
                                <td>Eco-friendly Media; Pendampingan Pengembangan Alat Peraga Edukatif Berbahan Limbah Di Kota Probolinggo</td>
                                <td>1</td>
